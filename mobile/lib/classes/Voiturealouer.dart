...
class Voiturealouer extends Voitures{
  Voiturealouer(int matricule, String marque, String modele, String puissance, String kilometrage, bool etat, String prix, int quantite, String couleur, DateTime date_dernier_entretien)
