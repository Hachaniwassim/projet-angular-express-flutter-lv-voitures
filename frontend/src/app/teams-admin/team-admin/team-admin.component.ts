...
export class TeamAdminComponent implements OnInit {
  ...
  constructor( public teamAdminservice : TeamAdminService, private notificationteamAdminservice : NotificationService,public dialogRef: MatDialogRef<TeamAdminComponent>) { }
  ...
  onSubmit() {
    if (this.teamAdminservice.form.valid) {
      if ( ! this.teamAdminservice.form.get('_id')?.value)
